...
public class WindRose {
    private static final List<Character> CARDEAL_POINTS = Arrays.asList('N',
            'E', 'S', 'W');
    ...
    public char getSibling(char point, char direction) {
        return CARDEAL_POINTS
                .get(fixPositionOverlap(getNextPosition(direction, indexOf(point))));
    }
     ...
     * point.
     *
     * @param direction L or R, representing Left or Right: the side to walk
     * @param index     the current WIND_ROSE List index.
